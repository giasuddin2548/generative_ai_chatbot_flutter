...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  Future<void> _sendImagePrompt(String message) async {
    ...
    try {
      ByteData catBytes = await rootBundle.load('assets/images/man.jpg');
      ByteData sconeBytes = await rootBundle.load('assets/images/women.jpg');
      final content = [
        Content.multi([
          TextPart(message),
      ...
      _generatedContent.add((
      image: Image.asset("assets/images/women.jpg"),
      text: null,
      fromUser: true
      ));
